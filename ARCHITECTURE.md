...
| `src/lib/terminal-renderer.ts` | Pure WebGL ownership policy: only a shown terminal in a focused PADE window may hold a GPU context; background/unfocused terminals stay live on xterm's fallback renderer | `Terminal` |
